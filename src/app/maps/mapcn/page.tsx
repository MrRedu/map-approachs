...
const PharmacyPopup = ({ properties, onClose }: PharmacyPopupProps) => {
  return (
    <MapPopup
      key={`${properties.lng}-${properties.lat}`}
      ...
      <div className="space-y-2 p-3">
        ...
        <div className="flex items-center gap-3 text-sm">
          <div className="flex items-center gap-1">
            ...
            <span className="font-medium">{properties.rating}</span>
            <span className="text-muted-foreground">
              ({properties.reviews.toLocaleString()})
            </span>
          </div>
        </div>
